...
18. completed advisory copilot output must pass the Advise-owned approved provider/model inventory
   ...
   `contracts/advisory-copilot/approved-model-inventory.v1.json`, then pass claim-level source
   ...
   completed output can be persisted. Each provider claim must cite source refs from the input
