...
- Generated At: `2026-06-13T15:19:45.115357+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1319 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 350 |
...
- Radon analyzed block inventory: `3738`
- Radon complexity rank inventory: `A=3591, B=147`
...
- Interrogate docstring inventory: `total=4121, missing=4086, covered=35, coverage=0.8%`
