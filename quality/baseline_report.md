...
- Generated At: `2026-06-17T01:50:26.906554+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1372 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 394 |
...
- Radon analyzed block inventory: `3821`
- Radon complexity rank inventory: `A=3701, B=120`
...
- Interrogate docstring inventory: `total=4206, missing=4171, covered=35, coverage=0.8%`
