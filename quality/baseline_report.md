...
- Generated At: `2026-06-17T07:17:16.828975+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1416 |
...
| 10 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 13 | 227 |
...
- Radon analyzed block inventory: `3863`
- Radon complexity rank inventory: `A=3761, B=102`
...
- Interrogate docstring inventory: `total=4248, missing=4213, covered=35, coverage=0.8%`
