...
flowchart LR
    ...
    Render --> Archive[Future archive artifact realization]
...
advisory narrative rendering. Proposal narrative is still not a domain data product,
trust-telemetry fixture, client-ready commentary, `/platform/capabilities` feature,
Gateway/Workbench surface, standalone read/regeneration API, or archive artifact until the later
