...
- Radon analyzed block inventory: `3508`
- Radon complexity rank inventory: `A=3306, B=202`
...
- Interrogate docstring inventory: `total=3892, missing=3857, covered=35, coverage=0.9%`
