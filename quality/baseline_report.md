...
- Generated At: `2026-06-12T11:03:13.432937+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1211 |
...
| 3 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 711 | 293 |
...
- Radon analyzed block inventory: `3379`
- Radon complexity rank inventory: `A=3133, B=246`
...
- Interrogate docstring inventory: `total=3763, missing=3728, covered=35, coverage=0.9%`
