...
| `RFC-0027` | Governed advisory AI copilot | Adds bounded AI workflow-pack actions for proposal explanation, evidence Q&A, meeting preparation, compliance summary, operations/report handoff summary, and advisor-reviewed client follow-up drafts. | Planned feature implementation; Slice 0 is ready for implementation, Slice 1 is complete as non-promoting platform-scaffolding review, Slice 2 adds the Advise copilot domain foundation without runtime support promotion, Slice 3 blocks premature data-product and capability promotion, and Slice 4 strengthens pure evidence-packet, unsupported-evidence, lineage, retention, and review-state vocabulary. All supporting seed, automation, Gateway, Workbench, `lotus-ai`, data-mesh, production, documentation, and proof work remains inside RFC-0027 before any supported copilot claim is promoted. |
