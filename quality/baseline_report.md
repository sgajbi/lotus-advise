...
- Radon analyzed block inventory: `3492`
- Radon complexity rank inventory: `A=3283, B=209`
...
- Interrogate docstring inventory: `total=3876, missing=3841, covered=35, coverage=0.9%`
