...
- Generated At: `2026-06-13T12:07:53.463614+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1300 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 333 |
...
- Radon analyzed block inventory: `3700`
- Radon complexity rank inventory: `A=3542, B=158`
...
- Interrogate docstring inventory: `total=4086, missing=4051, covered=35, coverage=0.9%`
