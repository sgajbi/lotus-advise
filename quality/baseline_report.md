...
- Generated At: `2026-06-13T11:32:23.263788+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1297 |
...
| 3 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 330 |
...
- Radon analyzed block inventory: `3686`
- Radon complexity rank inventory: `A=3524, B=162`
...
- Interrogate docstring inventory: `total=4072, missing=4037, covered=35, coverage=0.9%`
