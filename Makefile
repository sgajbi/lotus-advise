...
check: lint typecheck openapi-gate no-alias-gate api-vocabulary-gate domain-data-products-gate external-adapter-contracts docs-source-reference-gate slo-capacity-gate migration-rollout-contract-gate quality-baseline-check bandit-severity-regression-gate license-ip-gate release-image-provenance-gate test

ci: verify-dependencies lint typecheck openapi-gate no-alias-gate api-vocabulary-gate domain-data-products-gate docs-source-reference-gate slo-capacity-gate migration-rollout-contract-gate quality-baseline-check migration-smoke security-audit license-ip-gate release-image-provenance-gate coverage-combined docker-build postgres-runtime-contracts-local production-profile-guardrail-negatives-local
...
ci-local: verify-dependencies lint typecheck openapi-gate no-alias-gate api-vocabulary-gate domain-data-products-gate docs-source-reference-gate slo-capacity-gate migration-rollout-contract-gate quality-baseline-check migration-smoke security-audit license-ip-gate release-image-provenance-gate coverage-combined
