...
| RFC-0021 | DPM OpenAPI Contract Hardening and Separation of Request/Response Models | IMPLEMENTED (PHASE 1 - CONTRACT TEST HARDENING) | RFC-0007A, RFC-0016, RFC-0017 | `docs/rfcs/RFC-0021-dpm-openapi-contract-hardening.md` |
...
| RFC-0023 | DPM Persistent Supportability Store and Lineage APIs | DRAFT | RFC-0017, RFC-0018, RFC-0019 | `docs/rfcs/RFC-0023-dpm-persistent-supportability-store-and-lineage-apis.md` |
