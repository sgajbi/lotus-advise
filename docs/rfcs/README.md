...
| RFC-0009 | Tax-Aware Rebalancing (HIFO and Tax Budget) | IMPLEMENTED (Feature-Flagged via options.enable_tax_awareness) | RFC-0008 | `docs/rfcs/RFC-0009-tax-aware-rebalancing-hifo-tax-budget.md` |
| RFC-0010 | Turnover & Transaction Cost Control | IMPLEMENTED (Turnover Cap v1; Explicit Cost Model Deferred) | RFC-0007A | `docs/rfcs/RFC-0010-turnover-transaction-cost-control.md` |
| RFC-0011 | Settlement Awareness (Cash Ladder & Overdraft Protection) | IMPLEMENTED (Feature-Flagged via options.enable_settlement_awareness) | RFC-0007A | `docs/rfcs/RFC-0011-settlement-awareness-cash-ladder-overdraft-protection.md` |
