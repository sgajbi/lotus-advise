...
| RFC-0004 | Iterative Advisory Proposal Workspace Contract | PROPOSED | Active future work; Slice 1 implemented | RFC-0013, RFC-0003 | `docs/rfcs/RFC-0004-iterative-advisory-proposal-workspace-contract.md` |
...
Implementation note:
- `RFC-0004` Slice 1 is implemented, but later workspace slices are still pending.
