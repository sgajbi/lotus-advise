...
- Generated At: `2026-06-19T08:23:24.005258+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1534 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 462 |
...
| 5 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 272 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1237 | 230 |
...
- Radon analyzed block inventory: `3939`
- Radon complexity rank inventory: `A=3863, B=76`
...
- Interrogate docstring inventory: `total=4380, missing=4345, covered=35, coverage=0.8%`
