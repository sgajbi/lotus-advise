...
def test_proposal_simulate_endpoint_success(client):
    payload = {
        "portfolio_snapshot": {
...
def test_proposal_simulate_requires_feature_flag(client):
    payload = {
...
def test_proposal_simulate_idempotency_conflict_returns_409(client):
    payload = {
...
def test_proposal_simulate_returns_cached_response_on_same_payload(client):
    payload = {
