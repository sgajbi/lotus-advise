...
- Generated At: `2026-06-13T13:47:46.353630+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1313 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 345 |
...
- Radon analyzed block inventory: `3728`
- Radon complexity rank inventory: `A=3577, B=151`
...
- Interrogate docstring inventory: `total=4111, missing=4076, covered=35, coverage=0.9%`
