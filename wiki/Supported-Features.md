...
| `RFC-0026` | Advisor cockpit operating workflow | Creates backend-owned advisor worklists, action items, meeting-preparation packets, and workflow readiness summaries. | Ready for implementation after 2026-05-27 gold-standard tightening; no runtime advisor-cockpit support claim is promoted until backend, Gateway, Workbench, data-product, canonical `RFC26_ADVISOR_COCKPIT_CANONICAL` automation, docs, and live evidence are complete. |
