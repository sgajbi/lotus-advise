...
- Generated At: `2026-06-16T23:52:43.447955+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1355 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 380 |
...
- Radon analyzed block inventory: `3801`
- Radon complexity rank inventory: `A=3672, B=129`
...
- Interrogate docstring inventory: `total=4186, missing=4151, covered=35, coverage=0.8%`
