...
- Generated At: `2026-06-18T17:42:29.402543+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1454 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 734 | 422 |
...
| 8 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 13 | 239 |
| 9 | `_validate_live_proposal_alternatives_paths` | `scripts/validate_cross_service_parity_live.py` | 608 | 230 |
| 10 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1158 | 229 |
...
- Interrogate docstring inventory: `total=4311, missing=4276, covered=35, coverage=0.8%`
