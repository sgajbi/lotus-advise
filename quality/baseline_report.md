...
- Generated At: `2026-06-13T05:41:14.540967+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1275 |
...
| 3 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 308 |
...
- Radon analyzed block inventory: `3589`
- Radon complexity rank inventory: `A=3406, B=183`
...
- Interrogate docstring inventory: `total=3976, missing=3941, covered=35, coverage=0.9%`
