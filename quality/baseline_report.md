...
- Generated At: `2026-06-19T14:15:55.245382+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1553 |
...
| 4 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 287 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1252 | 234 |
...
- Radon analyzed block inventory: `3964`
- Radon complexity rank inventory: `A=3898, B=66`
...
- Interrogate docstring inventory: `total=4405, missing=4370, covered=35, coverage=0.8%`
