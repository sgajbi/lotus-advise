...
- Generated At: `2026-06-19T11:21:39.062583+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1542 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 470 |
...
| 4 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 278 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1245 | 230 |
...
- Radon analyzed block inventory: `3950`
- Radon complexity rank inventory: `A=3878, B=72`
...
- Interrogate docstring inventory: `total=4391, missing=4356, covered=35, coverage=0.8%`
