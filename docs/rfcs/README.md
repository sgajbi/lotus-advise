...
| RFC-0006 | lotus-advise Target Operating Model and Integration Architecture | PROPOSED | Active architecture RFC; Slices 1-3 implemented | RFC-0013, RFC-0003, RFC-0004 | `docs/rfcs/RFC-0006-lotus-advise-target-operating-model-and-integration-architecture.md` |
...
Implementation note:
- `RFC-0006` Slices 1-3 are implemented, but the parent RFC remains open because later slices are still pending.
