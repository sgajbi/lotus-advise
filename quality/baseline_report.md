...
- Radon analyzed block inventory: `3505`
- Radon complexity rank inventory: `A=3300, B=205`
...
- Interrogate docstring inventory: `total=3889, missing=3854, covered=35, coverage=0.9%`
