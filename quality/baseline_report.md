...
- Generated At: `2026-06-19T06:34:35.775775+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1522 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 450 |
...
| 6 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 262 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1225 | 230 |
...
- Radon analyzed block inventory: `3925`
- Radon complexity rank inventory: `A=3842, B=83`
...
- Interrogate docstring inventory: `total=4366, missing=4331, covered=35, coverage=0.8%`
