...
- Generated At: `2026-06-13T07:19:29.442304+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1278 |
...
| 3 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 311 |
...
- Radon analyzed block inventory: `3637`
- Radon complexity rank inventory: `A=3463, B=174`
...
- Interrogate docstring inventory: `total=4023, missing=3988, covered=35, coverage=0.9%`
