...
- Generated At: `2026-06-19T13:37:52.989620+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1552 |
...
| 4 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 286 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1252 | 233 |
...
- Radon analyzed block inventory: `3961`
- Radon complexity rank inventory: `A=3893, B=68`
...
- Interrogate docstring inventory: `total=4402, missing=4367, covered=35, coverage=0.8%`
