...
- RFC-0023 Slice 11E Gateway/Workbench realization evidence lives in
  ...
  narrative posture while compliance-review, client-draft, client-ready, standalone
  read/regeneration APIs, data-product, trust-telemetry, canonical demo screenshot proof, and
  `/platform/capabilities` promotion remain gated.
