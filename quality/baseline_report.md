...
- Radon analyzed block inventory: `3318`
- Radon complexity rank inventory: `A=3057, B=253, C=8`
...
- Interrogate docstring inventory: `total=3704, missing=3669, covered=35, coverage=0.9%`
