...
| Advisory copilot | Supported for governed evidence packets, claim-level source grounding, guardrails, workflow-pack integration, trusted-principal run review, maker-checker audit, retention, certified APIs, and product-realization proof. Unsupported or unverifiable AI claims remain not review-ready, and request-body actor fields cannot authorize review actions. | RFC-0027 tests and API contract evidence. |
