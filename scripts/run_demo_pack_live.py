...
def run_demo_pack(base_url: str) -> None:
    ...
    lifecycle_idem_20 = f"live-demo-lifecycle-20-{uuid.uuid4().hex[:8]}"
    with httpx.Client(base_url=base_url, timeout=timeout) as client:
        # Advisory simulation demos
        advisory_expected = {
        ...
        transition = _run_scenario(
            ...
            method="POST",
            path=f"/advisory/proposals/{proposal_id}/transitions",
            expected_http=200,
        ...
        compliance = _run_scenario(
            ...
            method="POST",
            path=f"/advisory/proposals/{proposal_id}/approvals",
            expected_http=200,
