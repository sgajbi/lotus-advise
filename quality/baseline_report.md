...
- Generated At: `2026-06-05T06:37:34.688056+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1181 |
...
| 5 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 711 | 265 |
...
- Radon analyzed block inventory: `3242`
- Radon complexity rank inventory: `A=2968, B=253, C=21`
...
- Interrogate docstring inventory: `total=3626, missing=3591, covered=35, coverage=1.0%`
