...
- Generated At: `2026-06-17T00:09:38.104233+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1358 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 383 |
...
- Radon analyzed block inventory: `3804`
- Radon complexity rank inventory: `A=3677, B=127`
...
- Interrogate docstring inventory: `total=4189, missing=4154, covered=35, coverage=0.8%`
