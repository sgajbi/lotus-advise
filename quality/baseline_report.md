...
- Generated At: `2026-06-13T11:49:28.936510+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1299 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 332 |
...
- Radon analyzed block inventory: `3697`
- Radon complexity rank inventory: `A=3538, B=159`
...
- Interrogate docstring inventory: `total=4083, missing=4048, covered=35, coverage=0.9%`
