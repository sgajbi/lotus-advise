...
- Generated At: `2026-06-19T04:39:26.957224+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1510 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 438 |
...
| 6 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 253 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1213 | 230 |
...
- Radon analyzed block inventory: `3910`
- Radon complexity rank inventory: `A=3823, B=87`
...
- Interrogate docstring inventory: `total=4351, missing=4316, covered=35, coverage=0.8%`
