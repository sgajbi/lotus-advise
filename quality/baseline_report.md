...
- Generated At: `2026-06-17T05:31:45.014185+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1409 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 407 |
...
- Radon analyzed block inventory: `3836`
- Radon complexity rank inventory: `A=3728, B=108`
...
- Interrogate docstring inventory: `total=4221, missing=4186, covered=35, coverage=0.8%`
