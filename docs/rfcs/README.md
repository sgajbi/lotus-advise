...
- RFC-0023 Slice 11B/11C report and render realization evidence lives in
  ...
  `lotus-render` now renders the optional portfolio-review advisory narrative page while
  `lotus-archive`, Gateway, Workbench, client-ready, data-product, trust-telemetry, and
  `/platform/capabilities` promotion remain gated.
