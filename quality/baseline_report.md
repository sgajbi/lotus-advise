...
- Generated At: `2026-06-13T10:35:17.439155+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1289 |
...
| 3 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 322 |
...
- Radon analyzed block inventory: `3675`
- Radon complexity rank inventory: `A=3509, B=166`
...
- Interrogate docstring inventory: `total=4061, missing=4026, covered=35, coverage=0.9%`
