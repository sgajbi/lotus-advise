...
- Generated At: `2026-06-16T23:17:56.168620+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1347 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 375 |
...
- Radon analyzed block inventory: `3792`
- Radon complexity rank inventory: `A=3663, B=129`
...
- Interrogate docstring inventory: `total=4177, missing=4142, covered=35, coverage=0.8%`
