...
- Generated At: `2026-06-13T18:27:40.342035+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1343 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 371 |
...
- Radon analyzed block inventory: `3789`
- Radon complexity rank inventory: `A=3659, B=130`
...
- Interrogate docstring inventory: `total=4174, missing=4139, covered=35, coverage=0.8%`
