...
- Generated At: `2026-06-19T04:14:58.760005+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1508 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 436 |
...
| 7 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 252 |
| 8 | `_assert_lifecycle_and_delivery_flow` | `scripts/validate_cross_service_parity_live.py` | 1788 | 249 |
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1211 | 230 |
...
- Radon analyzed block inventory: `3905`
- Radon complexity rank inventory: `A=3817, B=88`
...
- Interrogate docstring inventory: `total=4346, missing=4311, covered=35, coverage=0.8%`
