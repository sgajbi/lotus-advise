...
- Generated At: `2026-06-19T07:13:59.950691+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1528 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 456 |
...
| 6 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 267 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1231 | 230 |
...
- Radon analyzed block inventory: `3934`
- Radon complexity rank inventory: `A=3854, B=80`
...
- Interrogate docstring inventory: `total=4375, missing=4340, covered=35, coverage=0.8%`
