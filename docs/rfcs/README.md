...
| RFC-0027 | Governed Advisory AI Copilot | IMPLEMENTED for governed internal advisor/reviewer copilot interactions; client-ready and execution authority remain gated | Active crown-jewel feature source of truth. RFC-0027 implements all six supported action families across Advise, `lotus-ai`, Gateway, Workbench, canonical `PB_SG_GLOBAL_BAL_001` proof, and active `AdvisoryCopilotInteractionRecord:v1` data-product posture. Evidence packets and review events remain audit records inside the interaction product boundary rather than standalone promoted products. Client-ready publication, external client communication, policy approval/sign-off authority, OMS order lifecycle, fills, settlement, and full RFC-0028 demo/RFP claims remain gated. | RFC-0021, RFC-0022, RFC-0023, RFC-0024, RFC-0025, RFC-0026 | `docs/rfcs/RFC-0027-governed-advisory-ai-copilot.md` |
