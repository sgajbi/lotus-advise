...
- Generated At: `2026-06-17T01:27:01.551389+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1369 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 392 |
...
- Radon analyzed block inventory: `3820`
- Radon complexity rank inventory: `A=3699, B=121`
...
- Interrogate docstring inventory: `total=4205, missing=4170, covered=35, coverage=0.8%`
