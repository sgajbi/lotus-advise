...
- Generated At: `2026-06-13T15:43:43.548732+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1322 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 352 |
...
- Radon analyzed block inventory: `3741`
- Radon complexity rank inventory: `A=3595, B=146`
...
- Interrogate docstring inventory: `total=4124, missing=4089, covered=35, coverage=0.8%`
