...
- Generated At: `2026-06-13T17:16:59.797352+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1336 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 365 |
...
- Radon analyzed block inventory: `3773`
- Radon complexity rank inventory: `A=3634, B=139`
...
- Interrogate docstring inventory: `total=4156, missing=4121, covered=35, coverage=0.8%`
