...
- Generated At: `2026-06-13T07:38:49.442986+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1280 |
...
| 3 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 313 |
...
- Radon analyzed block inventory: `3647`
- Radon complexity rank inventory: `A=3475, B=172`
...
- Interrogate docstring inventory: `total=4033, missing=3998, covered=35, coverage=0.9%`
