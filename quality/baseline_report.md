...
- Generated At: `2026-06-19T09:25:25.843867+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1540 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 468 |
...
| 4 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 277 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1243 | 230 |
...
- Radon analyzed block inventory: `3947`
- Radon complexity rank inventory: `A=3874, B=73`
...
- Interrogate docstring inventory: `total=4388, missing=4353, covered=35, coverage=0.8%`
