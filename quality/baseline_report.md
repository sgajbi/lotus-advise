...
- Generated At: `2026-06-05T06:33:45.902251+00:00`
...
| 10 | `scripts/quality_baseline_report.py` | 1178 |
...
| 5 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 711 | 262 |
...
- Radon analyzed block inventory: `3238`
- Radon complexity rank inventory: `A=2964, B=252, C=22`
...
- Interrogate docstring inventory: `total=3622, missing=3587, covered=35, coverage=1.0%`
