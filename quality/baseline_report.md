...
- Generated At: `2026-06-19T02:26:21.144697+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1468 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 746 | 424 |
...
| 8 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 47 | 242 |
| 9 | `_validate_live_proposal_alternatives_paths` | `scripts/validate_cross_service_parity_live.py` | 608 | 230 |
| 10 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1172 | 229 |
...
- Interrogate docstring inventory: `total=4315, missing=4280, covered=35, coverage=0.8%`
