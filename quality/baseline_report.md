...
- Generated At: `2026-06-13T14:58:55.878482+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1317 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 348 |
...
- Radon analyzed block inventory: `3736`
- Radon complexity rank inventory: `A=3588, B=148`
...
- Interrogate docstring inventory: `total=4119, missing=4084, covered=35, coverage=0.8%`
