...
- Generated At: `2026-06-13T16:58:02.153236+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1333 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 362 |
...
- Radon analyzed block inventory: `3768`
- Radon complexity rank inventory: `A=3627, B=141`
...
- Interrogate docstring inventory: `total=4151, missing=4116, covered=35, coverage=0.8%`
