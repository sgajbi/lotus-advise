...
- Generated At: `2026-06-17T02:07:55.589304+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1375 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 396 |
...
- Radon analyzed block inventory: `3825`
- Radon complexity rank inventory: `A=3706, B=119`
...
- Interrogate docstring inventory: `total=4210, missing=4175, covered=35, coverage=0.8%`
