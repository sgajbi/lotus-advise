...
- Generated At: `2026-06-19T11:54:19.754769+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1544 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 472 |
...
| 4 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 281 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1247 | 230 |
...
- Radon analyzed block inventory: `3955`
- Radon complexity rank inventory: `A=3884, B=71`
...
- Interrogate docstring inventory: `total=4396, missing=4361, covered=35, coverage=0.8%`
