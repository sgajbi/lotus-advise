...
- Generated At: `2026-06-19T03:54:47.355090+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1507 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 435 |
...
| 7 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 250 |
| 8 | `_assert_lifecycle_and_delivery_flow` | `scripts/validate_cross_service_parity_live.py` | 1788 | 249 |
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1210 | 230 |
...
- Radon analyzed block inventory: `3891`
- Radon complexity rank inventory: `A=3798, B=93`
...
- Interrogate docstring inventory: `total=4332, missing=4297, covered=35, coverage=0.8%`
