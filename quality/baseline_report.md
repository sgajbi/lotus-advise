...
- Radon analyzed block inventory: `3544`
- Radon complexity rank inventory: `A=3350, B=194`
...
- Interrogate docstring inventory: `total=3928, missing=3893, covered=35, coverage=0.9%`
