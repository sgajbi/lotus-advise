...
- Generated At: `2026-06-19T06:53:52.582489+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1525 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 453 |
...
| 6 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 266 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1228 | 230 |
...
- Radon analyzed block inventory: `3930`
- Radon complexity rank inventory: `A=3849, B=81`
...
- Interrogate docstring inventory: `total=4371, missing=4336, covered=35, coverage=0.8%`
