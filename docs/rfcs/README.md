...
| RFC-0004 | Iterative Advisory Proposal Workspace Contract | PROPOSED | Active future work; Slices 1-2 implemented | RFC-0013, RFC-0003 | `docs/rfcs/RFC-0004-iterative-advisory-proposal-workspace-contract.md` |
...
Implementation note:
- `RFC-0004` Slices 1-2 are implemented, but later workspace slices are still pending.
