...
- Generated At: `2026-06-19T07:57:45.038159+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1532 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 460 |
...
| 6 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 271 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1235 | 230 |
...
- Radon analyzed block inventory: `3938`
- Radon complexity rank inventory: `A=3861, B=77`
...
- Interrogate docstring inventory: `total=4379, missing=4344, covered=35, coverage=0.8%`
