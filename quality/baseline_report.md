...
- Radon analyzed block inventory: `3319`
- Radon complexity rank inventory: `A=3059, B=253, C=7`
...
- Interrogate docstring inventory: `total=3705, missing=3670, covered=35, coverage=0.9%`
