...
| RFC-0028 | Bank Demo Journey and Client-Ready Proof | DRAFT - SLICE 0 DECISIONS LOCKED | Active crown-jewel feature roadmap; Slice 0 selects hybrid Advise proof APIs plus platform/front-office automation, primary canonical portfolio `PB_SG_GLOBAL_BAL_001`, scenario `RFC28_BANK_DEMO_CLIENT_READY_PROOF_CANONICAL`, and proof marker `BANK_DEMO_PROOF_PACK_CREATED`. RFC is the execution source and WTBD is closed historical context only. | RFC-0013, RFC-0019, RFC-0020, RFC-0021, RFC-0022, RFC-0023, RFC-0024, RFC-0025, RFC-0026, RFC-0027 | `docs/rfcs/RFC-0028-bank-demo-journey-and-client-ready-proof.md` |
