...
class AdvisoryCopilotRunRecord(BaseModel):
    ...
    def _normalize_required_run_text(cls, value: str) -> str:
        return normalize_required_record_text(value, error_code="COPILOT_RUN_RECORD_REQUIRED")
    ...
    def _normalize_optional_run_text(cls, value: str | None) -> str | None:
        return normalize_optional_record_text(value, error_code="COPILOT_RUN_RECORD_REQUIRED")
