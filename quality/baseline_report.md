...
- Generated At: `2026-06-19T03:14:34.305196+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1504 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 432 |
...
| 8 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 247 |
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1207 | 230 |
...
- Radon analyzed block inventory: `3882`
- Radon complexity rank inventory: `A=3787, B=95`
...
- Interrogate docstring inventory: `total=4323, missing=4288, covered=35, coverage=0.8%`
