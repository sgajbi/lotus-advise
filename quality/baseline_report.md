...
- Generated At: `2026-06-19T07:36:23.348108+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1530 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 458 |
...
| 6 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 268 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1233 | 230 |
...
- Radon analyzed block inventory: `3936`
- Radon complexity rank inventory: `A=3857, B=79`
...
- Interrogate docstring inventory: `total=4377, missing=4342, covered=35, coverage=0.8%`
