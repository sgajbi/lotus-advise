...
- Generated At: `2026-06-19T05:00:10.500963+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1512 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 440 |
...
| 6 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 254 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1215 | 230 |
...
- Radon analyzed block inventory: `3919`
- Radon complexity rank inventory: `A=3833, B=86`
...
- Interrogate docstring inventory: `total=4360, missing=4325, covered=35, coverage=0.8%`
