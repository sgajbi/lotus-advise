...
- Generated At: `2026-06-05T06:41:19.109884+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1184 |
...
| 5 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 711 | 268 |
...
- Radon analyzed block inventory: `3246`
- Radon complexity rank inventory: `A=2973, B=253, C=20`
...
- Interrogate docstring inventory: `total=3630, missing=3595, covered=35, coverage=1.0%`
