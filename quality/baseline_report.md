...
- Generated At: `2026-06-19T14:51:22.170644+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1557 |
...
| ---: | --- | --- | ---: | ---: |
| 1 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 774 | 479 |
...
| 4 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 288 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1255 | 235 |
...
- Radon analyzed block inventory: `3970`
- Radon complexity rank inventory: `A=3908, B=62`
...
- Interrogate docstring inventory: `total=4411, missing=4376, covered=35, coverage=0.8%`
