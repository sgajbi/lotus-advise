...
- Generated At: `2026-06-17T05:07:55.881010+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1406 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 405 |
...
- Radon analyzed block inventory: `3831`
- Radon complexity rank inventory: `A=3721, B=110`
...
- Interrogate docstring inventory: `total=4216, missing=4181, covered=35, coverage=0.8%`
