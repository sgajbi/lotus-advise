...
- Generated At: `2026-06-16T23:35:16.095135+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1349 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 377 |
...
- Radon analyzed block inventory: `3798`
- Radon complexity rank inventory: `A=3668, B=130`
...
- Interrogate docstring inventory: `total=4183, missing=4148, covered=35, coverage=0.8%`
