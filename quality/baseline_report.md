...
- Generated At: `2026-06-17T01:09:39.556945+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1366 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 390 |
...
- Radon analyzed block inventory: `3817`
- Radon complexity rank inventory: `A=3695, B=122`
...
- Interrogate docstring inventory: `total=4202, missing=4167, covered=35, coverage=0.8%`
