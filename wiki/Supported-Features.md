...
`/platform/capabilities` feature, standalone read/regeneration API, canonical demo screenshot
proof, or client-ready artifact until the later implementing slices close.
