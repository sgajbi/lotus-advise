...
- Radon analyzed block inventory: `3478`
- Radon complexity rank inventory: `A=3266, B=212`
...
- Interrogate docstring inventory: `total=3862, missing=3827, covered=35, coverage=0.9%`
