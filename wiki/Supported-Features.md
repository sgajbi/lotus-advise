...
| `RFC-0027` | Governed advisory AI copilot | Adds bounded AI workflow-pack actions for proposal explanation, evidence Q&A, meeting preparation, compliance summary, operations/report handoff summary, and advisor-reviewed client follow-up drafts. | Planned feature implementation; Slice 0 is ready for implementation and requires all supporting seed, automation, Gateway, Workbench, `lotus-ai`, data-mesh, production, documentation, and proof work inside RFC-0027 before any supported copilot claim is promoted. |
