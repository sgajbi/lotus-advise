...
- Generated At: `2026-06-13T12:29:23.003614+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1303 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 336 |
...
- Radon analyzed block inventory: `3706`
- Radon complexity rank inventory: `A=3549, B=157`
...
- Interrogate docstring inventory: `total=4092, missing=4057, covered=35, coverage=0.9%`
