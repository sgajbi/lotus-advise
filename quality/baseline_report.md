...
- Generated At: `2026-06-18T16:41:02.950489+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1437 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 721 | 418 |
...
| 8 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 13 | 234 |
| 9 | `_validate_live_proposal_alternatives_paths` | `scripts/validate_cross_service_parity_live.py` | 608 | 230 |
| 10 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1141 | 229 |
...
- Interrogate docstring inventory: `total=4295, missing=4260, covered=35, coverage=0.8%`
