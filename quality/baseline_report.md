...
- Generated At: `2026-06-19T09:06:27.098564+00:00`
...
| 8 | `scripts/quality_baseline_report.py` | 1538 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 466 |
...
| 5 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 274 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1241 | 230 |
...
- Radon analyzed block inventory: `3944`
- Radon complexity rank inventory: `A=3870, B=74`
...
- Interrogate docstring inventory: `total=4385, missing=4350, covered=35, coverage=0.8%`
