...
| `RFC-0027` | Governed advisory AI copilot | Adds bounded AI workflow-pack actions for proposal explanation, evidence Q&A, meeting preparation, compliance summary, operations/report handoff summary, and advisor-reviewed client follow-up drafts. | Planned feature implementation; Slice 0 is ready for implementation, Slice 1 is complete as non-promoting platform-scaffolding review, Slice 2 adds the Advise copilot domain foundation without runtime support promotion, Slice 3 blocks premature data-product and capability promotion, Slice 4 strengthens pure evidence-packet, unsupported-evidence, lineage, retention, and review-state vocabulary, Slice 5 adds pure evidence-packet projection without runtime support promotion, Slice 6 adds pure guardrail evaluation without runtime support promotion, Slice 7 adds governed `lotus-ai` workflow-pack execution and model-risk lineage without Advise API, Gateway, Workbench, data-product, canonical proof, or supported product promotion, Slice 8 adds durable run, idempotency, review, audit, retention, legal-hold, and Postgres migration support while rejecting raw prompt/provider/unsafe-output storage, and Slice 9 exposes Advise-owned copilot APIs, Workbench-safe proposal-version source projection, and OpenAPI while keeping Workbench, data-product, canonical proof, and supported product promotion unpromoted. Advise API and Gateway routes exist, but Workbench, data-product, canonical proof, and supported product promotion remain unpromoted until the later RFC-0027 slices prove them. All supporting seed, automation, Workbench, data-mesh, production, documentation, and proof work remains inside RFC-0027 before any supported copilot claim is promoted. |
