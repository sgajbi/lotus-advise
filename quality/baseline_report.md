...
- Generated At: `2026-06-17T06:46:36.005270+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1415 |
...
| 10 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 13 | 226 |
...
- Radon analyzed block inventory: `3858`
- Radon complexity rank inventory: `A=3755, B=103`
...
- Interrogate docstring inventory: `total=4243, missing=4208, covered=35, coverage=0.8%`
