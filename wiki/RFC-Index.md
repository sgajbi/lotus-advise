...
RFC-0028 status is `DRAFT - SLICE 0 DECISIONS LOCKED`. The first implementation target is a
...
`BANK_DEMO_PROOF_PACK_CREATED`. The RFC keeps full bank-demo/RFP and client-ready publication
claims unpromoted until implementation proof, Gateway/Workbench validation, supported-claim review,
and wiki publication are complete.
