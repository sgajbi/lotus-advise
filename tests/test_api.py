...
def test_simulate_endpoint_success():
    ...
    payload = {
        ...
        "model_portfolio": {
            "targets": [{"instrument_id": "SG_EQ_ETF", "weight": "1.00"}]
        },
        "shelf_entries": [
            {"instrument_id": "SG_EQ_ETF", "status": "APPROVED", "min_notional": {"amount": "1000", "currency": "SGD"}}
        ],
        "options": {
