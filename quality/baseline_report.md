...
- Generated At: `2026-06-13T16:02:16.064555+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1324 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 354 |
...
- Radon analyzed block inventory: `3744`
- Radon complexity rank inventory: `A=3599, B=145`
...
- Interrogate docstring inventory: `total=4127, missing=4092, covered=35, coverage=0.8%`
