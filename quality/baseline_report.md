...
- Generated At: `2026-06-19T08:42:13.622902+00:00`
...
| 7 | `tests/unit/advisory/engine/test_advisory_copilot_persistence.py` | 1688 |
| 8 | `scripts/quality_baseline_report.py` | 1536 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 773 | 464 |
...
| 5 | `test_quality_baseline_report_captures_required_quality_sections` | `tests/unit/scripts/test_quality_baseline_report.py` | 70 | 273 |
...
| 9 | `render_quality_scorecard` | `scripts/quality_baseline_report.py` | 1239 | 230 |
...
- Radon analyzed block inventory: `3941`
- Radon complexity rank inventory: `A=3866, B=75`
...
- Interrogate docstring inventory: `total=4382, missing=4347, covered=35, coverage=0.8%`
