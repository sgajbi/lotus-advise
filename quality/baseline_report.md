...
- Generated At: `2026-06-05T06:45:38.153258+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1186 |
...
| 5 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 711 | 270 |
...
- Radon analyzed block inventory: `3251`
- Radon complexity rank inventory: `A=2979, B=253, C=19`
...
- Interrogate docstring inventory: `total=3635, missing=3600, covered=35, coverage=1.0%`
