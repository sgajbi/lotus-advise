...
- Generated At: `2026-06-13T07:57:36.547918+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1282 |
...
| 3 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 315 |
...
- Radon analyzed block inventory: `3650`
- Radon complexity rank inventory: `A=3479, B=171`
...
- Interrogate docstring inventory: `total=4036, missing=4001, covered=35, coverage=0.9%`
