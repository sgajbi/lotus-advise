...
- Generated At: `2026-06-12T10:58:35.547513+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1208 |
...
| 3 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 711 | 290 |
...
- Radon analyzed block inventory: `3365`
- Radon complexity rank inventory: `A=3116, B=249`
...
- Interrogate docstring inventory: `total=3751, missing=3716, covered=35, coverage=0.9%`
