...
- Generated At: `2026-06-13T12:48:29.241514+00:00`
...
| 9 | `scripts/quality_baseline_report.py` | 1305 |
...
| 2 | `render_refactor_health_report` | `scripts/quality_baseline_report.py` | 718 | 338 |
...
- Radon analyzed block inventory: `3713`
- Radon complexity rank inventory: `A=3557, B=156`
...
- Interrogate docstring inventory: `total=4099, missing=4064, covered=35, coverage=0.9%`
